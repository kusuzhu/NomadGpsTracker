...
public class Converter {
    ...
    private static int CRC16_TABLE[] = { 0x0000, 0x1189, 0x2312, 0x329b,
    ...
    public static String intToByteArray(long value, int size) {
        String result = "";
        if (size <= 0)
            return result;
    ...
    public static void printHexString(String str) {
    ...
    public static List<Byte> intToByteArrayList(long value, int size) {
        List<Byte> result = new ArrayList<Byte>();
        if (size <= 0)
            return result;

        for (int i = size - 1; i >= 0; i--)
            result.add((byte) ((value >> (8 * i)) & 0xFF));
